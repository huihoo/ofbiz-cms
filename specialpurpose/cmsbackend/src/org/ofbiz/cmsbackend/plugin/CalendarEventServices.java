...
public class CalendarEventServices {
    public static final String module = CalendarEventServices.class.getName();
    public static final String LABEL_RESOURCE = "CmsBackendUiLabels";
    private final static String HTML_BR ="&lt;br&gt";
    
    
    public static Map<String, Object> createCalendarEvents(DispatchContext dctx,Map<String, ? extends Object> context)throws  GenericEntityException {
    ...
    public static Map<String, Object> deleteCalendarEvents(DispatchContext dctx,Map<String, ? extends Object> context)throws  GenericEntityException {
        Map<String, Object> result = ServiceUtil.returnSuccess();
        Delegator delegator = dctx.getDelegator();
    ...
    public static Map<String, Object> checkDisplayEvents(DispatchContext dctx,Map<String, ? extends Object> context)throws  GenericEntityException, GenericServiceException {
        Map<String, Object> result = ServiceUtil.returnSuccess();
        Delegator delegator = dctx.getDelegator();
